...
1) Safra Save é um módulo do sistema que usaria as APIs para coletar
dados dos clientes internos e externos ao Safra e assim, permitir que um 
analista do Safra avalie como prospectar novos clientes. No entanto, pela complexidade
desse módulo não foi possível a implementação final e, consequentemente, clicando no botão
mostrará uma mensagem da página em desenvolvimento.

2, 3, 4) Consiste no módulo que poderia se integrar ao Internet Banking do Safra
atuando através dos clientes Safras e realizando simulações que estimulariam o
...
e o aplicativo mostra quanto tempo leva para o cliente se tornar um milionário.

5) Requisitar Open Banking Branches: Neste meno foi feita apenas a implementação
...
liberadas na fase 1. Para os dois sistemas propostos os dados utilizados, 
